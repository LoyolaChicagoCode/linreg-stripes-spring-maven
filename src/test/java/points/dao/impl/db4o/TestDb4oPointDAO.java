 ...
 * here.
 */
public class TestDb4oPointDAO extends
		AbstractDependencyInjectionSpringContextTests implements PointDAOAware {
	...
	protected String[] getConfigLocations() {
		return new String[] { "classpath:applicationContextDb4oDAO.xml" };
	}
